...
def create_app():
    ...
    app.add_url_rule('/api/admin/orphaned-names', methods=['GET'], view_func=routes.admin_orphaned_names)
    app.add_url_rule('/api/admin/clear-orphaned-names', methods=['POST'], view_func=routes.admin_clear_orphaned_names)
